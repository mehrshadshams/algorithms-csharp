...
namespace AIMA.Tests.Search.Informed
{
    ...
    public class GreedyBestFirstSearchTests
    {
        ...
        public void TestPuzzle()
        {
            ...
            var search = new GreedyBestFirstSearch<EightPuzzleBoard, DynamicAction>(
            ...
            Assert.AreEqual(49, solution.Actions.Count);
        }
        ...
        public void TestAIMA3eFigure3_15()
        {
            ...
            Assert.AreEqual(SimplifiedRoadMapOfRomania.FAGARAS, actions[0].To);
            Assert.AreEqual(SimplifiedRoadMapOfRomania.BUCHAREST, actions[2].To);
            Assert.AreEqual(450.0, solution.ValueOrDefault().Cost);
        }
    }
}